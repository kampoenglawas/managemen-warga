...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'civilianManagement';
  ...
  'jhipster.mail.from' = 'civilianManagement@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'civilianManagement API';
  'jhipster.swagger.description' = 'civilianManagement API documentation';
  ...
  'eureka.instance.appname' = 'civilianManagement';
  'eureka.instance.instanceId' = 'civilianManagement:${random.value}';
  ...
  'cloud.config.name' = 'civilianManagement';
