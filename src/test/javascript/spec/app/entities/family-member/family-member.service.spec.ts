...
describe('Service Tests', () => {
  describe('FamilyMember Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(FamilyMemberService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new FamilyMember(0, FamilyRole.Father);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a FamilyMember', () => {
        ...
        service.create(new FamilyMember()).subscribe(resp => (expectedResult = resp.body));
