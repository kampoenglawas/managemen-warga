...
import { ResidenceComponent } from 'app/entities/residence/residence.component';
...
describe('Component Tests', () => {
  describe('Residence Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.residences && comp.residences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
