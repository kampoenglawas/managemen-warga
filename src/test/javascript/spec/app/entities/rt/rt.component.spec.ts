...
import { RTComponent } from 'app/entities/rt/rt.component';
import { RTService } from 'app/entities/rt/rt.service';
import { RT } from 'app/shared/model/rt.model';

describe('Component Tests', () => {
  describe('RT Management Component', () => {
    let comp: RTComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rTS && comp.rTS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
