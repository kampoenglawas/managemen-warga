...
import { CivilianComponent } from 'app/entities/civilian/civilian.component';
...
describe('Component Tests', () => {
  describe('Civilian Management Component', () => {
    let comp: CivilianComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [CivilianComponent],
        providers: [
          {
        ...
        .overrideTemplate(CivilianComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.civilians && comp.civilians[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
